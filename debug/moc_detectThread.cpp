...
QT_MOC_LITERAL(1, 13, 16), // "send_packet_info"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 16) // "QVector<QString>"

    },
    "detectThread\0send_packet_info\0\0"
    "QVector<QString>"
};
...
void detectThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->send_packet_info((*reinterpret_cast< QVector<QString>(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (detectThread::*)(QVector<QString> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&detectThread::send_packet_info)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void detectThread::send_packet_info(QVector<QString> _t1)
{
